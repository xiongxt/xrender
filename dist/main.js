...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/xrender.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _bus = __webpack_require__(/*! ./helpers/bus */ \"./src/helpers/bus.js\");\n\nvar _bus2 = _interopRequireDefault(_bus);\n\nvar _style = __webpack_require__(/*! ./helpers/style */ \"./src/helpers/style.js\");\n\nvar _style2 = _interopRequireDefault(_style);\n\nvar _attribute = __webpack_require__(/*! ./helpers/attribute */ \"./src/helpers/attribute.js\");\n\nvar _attribute2 = _interopRequireDefault(_attribute);\n\nvar _Event2 = __webpack_require__(/*! ./event/Event */ \"./src/event/Event.js\");\n\nvar _Event3 = _interopRequireDefault(_Event2);\n\nvar _util = __webpack_require__(/*! ./helpers/util */ \"./src/helpers/util.js\");\n\nvar _util2 = _interopRequireDefault(_util);\n\nvar _draggable = __webpack_require__(/*! ./event/draggable */ \"./src/event/draggable.js\");\n\nvar _draggable2 = _interopRequireDefault(_draggable);\n\nvar _animation = __webpack_require__(/*! ./helpers/animation */ \"./src/helpers/animation.js\");\n\nvar _animation2 = _interopRequireDefault(_animation);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Node = function (_Event) {\n    _inherits(Node, _Event);\n\n    function Node() {\n        var myStyle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n        var myAttrs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n\n        _classCallCheck(this, Node);\n\n        var _this = _possibleConstructorReturn(this, (Node.__proto__ || Object.getPrototypeOf(Node)).call(this));\n\n        _this.id = _util2.default.guid();\n        _this.style = Object.assign({}, _style2.default);\n        _this.attr = Object.assign({}, _attribute2.default);\n        _this.setStype(myStyle, false);\n        _this.setAttr(myAttrs, false);\n        _util2.default.mixin(_this, _animation2.default);\n        _this.children = [];\n        _this.needCheck = false;\n        _this.parent = null;\n        _this.isPointInPath = false;\n        _this.mouseStatus = [];\n\n        _this.offsetChangeAble = true;\n\n        _this._checkCursor();\n\n        _bus2.default.on('canvas/mousemove', function (_ref) {\n            var x = _ref.x,\n                y = _ref.y;\n\n            if (_this.attr.ignore !== true && _this.context) {\n                _this._setMouseLocation(x, y);\n                var inPath = _this._checkPointInPath();\n                if (inPath === false) {\n                    _this.recoredMouseStatus(false);\n                    _this.fireMouseLeaveEvents();\n                }\n                if (inPath) {\n                    return _this;\n                }\n            }\n        }).on('canvas/click', function (_ref2) {\n            var x = _ref2.x,\n                y = _ref2.y;\n\n            if (_this.attr.ignore !== true && _this.context) {\n                _this._setMouseLocation(x, y);\n                var inPath = _this._checkPointInPath();\n                if (inPath) {\n                    return _this;\n                }\n            }\n        }).on('canvas/mousedown', function (_ref3) {\n            var x = _ref3.x,\n                y = _ref3.y;\n\n            if (_this.attr.ignore !== true && _this.context) {\n                _this._setMouseLocation(x, y);\n                var inPath = _this._checkPointInPath();\n                if (inPath) {\n                    return _this;\n                }\n            }\n        });\n        return _this;\n    }\n\n    _createClass(Node, [{\n        key: '_setMouseLocation',\n        value: function _setMouseLocation(x, y) {\n            this.mouseX = x;\n            this.mouseY = y;\n            this._setOffsetPosition();\n        }\n\n        /**\r\n         * 记录鼠标位置相对于当前图形的坐标\r\n         */\n\n    }, {\n        key: '_setOffsetPosition',\n        value: function _setOffsetPosition() {\n            if (this.offsetChangeAble) {\n                this.offsetX = this.mouseX - this.style.start.x;\n                this.offsetY = this.mouseY - this.style.start.y;\n            }\n        }\n\n        /**\r\n         * 拖拽时，重新设置图形的位置信息\r\n         */\n\n    }, {\n        key: '_setDraggingPos',\n        value: function _setDraggingPos() {\n            this.setStype({\n                start: {\n                    x: this.mouseX - this.offsetX,\n                    y: this.mouseY - this.offsetY\n                }\n            });\n        }\n    }, {\n        key: '_checkPointInPath',\n        value: function _checkPointInPath() {\n            this._renderSelf(this.context2);\n            var inPath = false;\n            inPath = this.context2.isPointInPath(this.mouseX * this.canvasScale, this.mouseY * this.canvasScale);\n            this.context2.closePath();\n            return inPath;\n        }\n    }, {\n        key: '_renderSelf',\n        value: function _renderSelf() {}\n    }, {\n        key: '_renderChildren',\n        value: function _renderChildren() {\n            var sortArray = this.children.sort(function (item1, item2) {\n                return item1.style['z-index'] > item2.style['z-index'];\n            });\n            sortArray.forEach(function (item) {\n                item.render();\n            });\n        }\n    }, {\n        key: '_setEnvo',\n        value: function _setEnvo(envoParams) {\n            this.envoParams = envoParams;\n            _util2.default.mixin(this, envoParams);\n        }\n    }, {\n        key: '_checkCursor',\n        value: function _checkCursor() {\n            var _this2 = this;\n\n            if (this.style['cursor'] !== 'default' && this.usedCursor !== true) {\n                this.usedCursor = true;\n                this.on('mouseenter', function () {\n                    _this2.canvas.style.cursor = _this2.style.cursor;\n                });\n                this.on('mouseleave', function () {\n                    _this2.canvas.style.cursor = 'default';\n                });\n            }\n        }\n    }, {\n        key: 'render',\n        value: function render() {\n            if (this.attr.ignore !== true && this.context) {\n                this.renderIndex = this.envoParams.renderIndex + 1;\n                this.envoParams.renderIndex = this.renderIndex;\n                this._renderSelf();\n                this._renderChildren();\n            }\n        }\n    }, {\n        key: 'lockOffset',\n        value: function lockOffset() {\n            this.offsetChangeAble = false;\n        }\n    }, {\n        key: 'unlockOffset',\n        value: function unlockOffset() {\n            this.offsetChangeAble = true;\n        }\n    }, {\n        key: 'setStype',\n        value: function setStype(style) {\n            var repaint = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;\n\n            _util2.default.mixin(this.style, style);\n            this.originStyle = _util2.default.clone(this.style);\n            this._checkCursor();\n            if (repaint) {\n                _bus2.default.trigger('repaint');\n            }\n        }\n    }, {\n        key: 'setAttr',\n        value: function setAttr(attr) {\n            var repaint = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;\n\n            _util2.default.mixin(this.attr, attr);\n            if (this.attr.draggable) {\n                _draggable2.default.init(this);\n            }\n            if (repaint) {\n                _bus2.default.trigger('repaint');\n            }\n        }\n    }, {\n        key: 'addChild',\n        value: function addChild(node) {\n            node._setEnvo(this.envoParams);\n            node.setParent(this);\n            this.children.push(node);\n        }\n    }, {\n        key: 'delChild',\n        value: function delChild() {}\n    }, {\n        key: 'setParent',\n        value: function setParent(parent) {\n            this.parent = parent;\n        }\n    }]);\n\n    return Node;\n}(_Event3.default);\n\nexports.default = Node;\n\n//# sourceURL=webpack:///./src/Node.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Node = __webpack_require__(/*! ./Node */ \"./src/Node.js\");\n\nvar _Node2 = _interopRequireDefault(_Node);\n\nvar _util = __webpack_require__(/*! ./helpers/util */ \"./src/helpers/util.js\");\n\nvar _util2 = _interopRequireDefault(_util);\n\nvar _bus = __webpack_require__(/*! ./helpers/bus */ \"./src/helpers/bus.js\");\n\nvar _bus2 = _interopRequireDefault(_bus);\n\nvar _Event2 = __webpack_require__(/*! ./event/Event */ \"./src/event/Event.js\");\n\nvar _Event3 = _interopRequireDefault(_Event2);\n\nvar _draggable = __webpack_require__(/*! ./event/draggable */ \"./src/event/draggable.js\");\n\nvar _draggable2 = _interopRequireDefault(_draggable);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Render = function (_Event) {\n    _inherits(Render, _Event);\n\n    function Render(envoParams) {\n        _classCallCheck(this, Render);\n\n        var _this = _possibleConstructorReturn(this, (Render.__proto__ || Object.getPrototypeOf(Render)).call(this));\n\n        _util2.default.mixin(_this, envoParams);\n        _this.envoParams = envoParams;\n        _this.envoParams.renderObj = _this;\n        _this.root = new _Node2.default();\n        _this.root._setEnvo(envoParams);\n        _draggable2.default.setRender(_this);\n        _bus2.default.on('repaint', function () {\n            _this.render();\n        }).on('canvas/mousemove', function (_ref) {\n            var x = _ref.x,\n                y = _ref.y;\n\n            _this.fireEvent('mousemove');\n        }).on('canvas/mouseleave', function (event) {\n            _this.fireEvent('mouseleave');\n        }).on('canvas/mouseup', function (event) {\n            _this.fireEvent('mouseup');\n        });\n        return _this;\n    }\n\n    _createClass(Render, [{\n        key: 'render',\n        value: function render() {\n            var _this2 = this;\n\n            requestAnimationFrame(function () {\n                _this2.context.clearRect(0, 0, _this2.envoParams.canvasWidth, _this2.envoParams.canvasHeight);\n                _this2.envoParams.renderIndex = 0;\n                _this2.root.render();\n            });\n        }\n    }, {\n        key: 'addElement',\n        value: function addElement(node) {\n            this.root.addChild(node);\n        }\n    }, {\n        key: 'delElement',\n        value: function delElement(node) {\n            this.root.delChild(node);\n        }\n    }]);\n\n    return Render;\n}(_Event3.default);\n\nexports.default = Render;\n\n//# sourceURL=webpack:///./src/Render.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _util = __webpack_require__(/*! ./util */ \"./src/helpers/util.js\");\n\nvar _util2 = _interopRequireDefault(_util);\n\nvar _easying = __webpack_require__(/*! ./easying */ \"./src/helpers/easying.js\");\n\nvar _easying2 = _interopRequireDefault(_easying);\n\nvar _color = __webpack_require__(/*! ./color */ \"./src/helpers/color.js\");\n\nvar _color2 = _interopRequireDefault(_color);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\n/**\r\n * 过滤掉没有改变的属性\r\n */\nfunction getAnimateOptions(node, keyUrls, time) {\n    var curTime = new Date().getTime();\n    var animateOptions = {\n        start: curTime,\n        changlist: {},\n        allTime: time\n    };\n    Object.keys(keyUrls).forEach(function (keyUrl) {\n        var oldValue = _util2.default.getValueByAttr(node.style, keyUrl);\n        var destValue = keyUrls[keyUrl];\n        if (oldValue !== destValue) {\n            var type = 'number';\n            if (typeof destValue === 'string' && _color2.default.checkColor(destValue).isColor) {\n                type = 'color';\n            }\n            animateOptions.changlist[keyUrl] = {\n                old: oldValue,\n                dest: destValue,\n                type: type\n            };\n        }\n    });\n    return animateOptions;\n}\n\nexports.default = {\n    animate: function animate(dest) {\n        var time = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1000;\n        var easying = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'linear';\n\n        var keyUrls = _util2.default.getObjectKeys(dest);\n        this.animateOptions = getAnimateOptions(this, keyUrls, time);\n        this.animateOptions.dest = dest;\n        this.animateOptions.easying = easying;\n        console.log(this.animateOptions);\n        this.fireEvent('beforeAnimate');\n        this._startAnimate();\n    },\n    _startAnimate: function _startAnimate() {\n        var _this = this;\n\n        requestAnimationFrame(function () {\n            var curTime = new Date().getTime();\n            var animateOptions = _this.animateOptions;\n            if (animateOptions) {\n                var rate = (curTime - animateOptions.start) / animateOptions.allTime;\n                if (rate >= 1) {\n                    _this.setStype(animateOptions.dest);\n                    _this.fireEvent('afterAnimate');\n                    delete _this.animateOptions;\n                } else {\n                    rate = _easying2.default[animateOptions.easying](rate);\n                    if (rate !== 0) {\n                        _this.fireEvent('duringAnimate', { rate: rate });\n                        var dest = {};\n                        var changlist = animateOptions.changlist;\n                        Object.keys(changlist).forEach(function (keyUrl) {\n                            var data = changlist[keyUrl];\n                            var val = void 0;\n                            if (data.type === 'color') {\n                                val = _color2.default.getComputedColor(data.dest, data.old, rate);\n                            } else {\n                                val = (data.dest - data.old) * rate + data.old;\n                            }\n                            _util2.default.setValueByAttr(dest, keyUrl, val);\n                        });\n                        _this.setStype(dest);\n                    }\n                    _this._startAnimate();\n                }\n            }\n        });\n    }\n};\n\n//# sourceURL=webpack:///./src/helpers/animation.js?");

/***/ }),

/***/ "./src/helpers/attribute.js":
/*!**********************************!*\
  !*** ./src/helpers/attribute.js ***!
  \**********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.default = {\n    draggable: true,\n    resizable: false,\n    ignore: false\n};\n\n//# sourceURL=webpack:///./src/helpers/attribute.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _util = __webpack_require__(/*! ./util */ \"./src/helpers/util.js\");\n\nvar _util2 = _interopRequireDefault(_util);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar events = {};\n\nexports.default = {\n    trigger: function trigger() {\n        var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';\n        var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n\n        var funcs = events[name];\n        if (funcs) {\n            if (name === 'canvas/mousemove') {\n                var nodes = [];\n                funcs.forEach(function (func) {\n                    var res = func(data);\n                    if (res) {\n                        nodes.push(res);\n                    }\n                });\n                var node = _util2.default.getTopNode(nodes);\n                node && node.fireMouseMoveEvents();\n                nodes.forEach(function (_node) {\n                    if (_node !== node) {\n                        _node.fireMoveNotInPath();\n                    }\n                });\n                return;\n            }\n\n            if (name === 'canvas/click') {\n                var _nodes = [];\n                funcs.forEach(function (func) {\n                    var res = func(data);\n                    if (res) {\n                        _nodes.push(res);\n                    }\n                });\n                var _node2 = _util2.default.getTopNode(_nodes);\n                _node2 && _node2.fireEvent('click');\n                return;\n            }\n\n            if (name === 'canvas/mousedown') {\n                var _nodes2 = [];\n                funcs.forEach(function (func) {\n                    var res = func(data);\n                    if (res) {\n                        _nodes2.push(res);\n                    }\n                });\n                var _node3 = _util2.default.getTopNode(_nodes2);\n                _node3 && _node3.fireEvent('mousedown');\n                return;\n            }\n\n            funcs.forEach(function (func) {\n                func(data);\n            });\n        }\n    },\n    on: function on() {\n        var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';\n        var func = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};\n\n        if (events[name]) {\n            events[name].push(func);\n        } else {\n            events[name] = [func];\n        }\n        return this;\n    }\n};\n\n//# sourceURL=webpack:///./src/helpers/bus.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.default = {\n    linear: function linear(x) {\n        return x;\n    },\n    swing: function swing(x) {\n        return -Math.cos(x * Math.PI) / 2 + 0.5;\n    }\n};\n\n//# sourceURL=webpack:///./src/helpers/easying.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _typeof = typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\" ? function (obj) { return typeof obj; } : function (obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; };\n\nvar _color = __webpack_require__(/*! ./color */ \"./src/helpers/color.js\");\n\nvar _color2 = _interopRequireDefault(_color);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar timer = new Date().getTime();\n\nexports.default = {\n    mixin: function mixin() {\n        var source = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n        var target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n\n        Object.keys(target).forEach(function (key) {\n            source[key] = target[key];\n        });\n    },\n    guid: function guid() {\n        return timer++;\n    },\n    getArrayGroupByAttr: function getArrayGroupByAttr() {\n        var _this = this;\n\n        var array = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];\n        var attr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';\n\n        var res = {};\n        array.forEach(function (item) {\n            var val = _this.getValueByAttr(item, attr);\n            if (res[val]) {\n                res[val].push(item);\n            } else {\n                res[val] = [item];\n            }\n        });\n        return res;\n    },\n    getObjectKeys: function getObjectKeys(obj) {\n        var _this2 = this;\n\n        var startStr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';\n        var keyUrls = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};\n\n        Object.keys(obj).forEach(function (key) {\n            if (_typeof(obj[key]) === 'object') {\n                _this2.getObjectKeys(obj[key], key, keyUrls);\n            } else if (typeof obj[key] === 'number') {\n                if (startStr) {\n                    keyUrls[startStr + '.' + key] = obj[key];\n                } else {\n                    keyUrls[key] = obj[key];\n                }\n            } else if (typeof obj[key] === 'string' && _color2.default.checkColor(obj[key]).isColor) {\n                keyUrls[key] = obj[key];\n            }\n        });\n        return keyUrls;\n    },\n    getValueByAttr: function getValueByAttr(obj, attr) {\n        var array = attr.split('.');\n        array.forEach(function (key) {\n            obj = obj[key];\n        });\n        return obj;\n    },\n    setValueByAttr: function setValueByAttr(obj, attr, val) {\n        var array = attr.split('.');\n        if (array.length === 1) {\n            obj[attr] = val;\n        } else {\n            var last = array.splice(-1)[0];\n            var _obj = obj;\n            array.forEach(function (key) {\n                if (!obj[key]) {\n                    obj[key] = {};\n                }\n                _obj = obj[key];\n            });\n            _obj[last] = val;\n        }\n    },\n    getTopNode: function getTopNode(nodes) {\n        var max = 0;\n        var finalNode = null;\n        nodes.forEach(function (node) {\n            if (node.renderIndex > max) {\n                finalNode = node;\n                max = node.renderIndex;\n            }\n        });\n        return finalNode;\n    },\n    isHans: function isHans(str) {\n        return (/^[\\u3220-\\uFA29]+$/.test(str)\n        );\n    },\n    clone: function clone(obj) {\n        if ((typeof obj === 'undefined' ? 'undefined' : _typeof(obj)) !== 'object') {\n            return obj;\n        }\n        var newobj = {};\n        for (var attr in obj) {\n            newobj[attr] = this.clone(obj[attr]);\n        }\n        return newobj;\n    }\n};\n\n//# sourceURL=webpack:///./src/helpers/util.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Node2 = __webpack_require__(/*! ../Node */ \"./src/Node.js\");\n\nvar _Node3 = _interopRequireDefault(_Node2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Circle = function (_Node) {\n    _inherits(Circle, _Node);\n\n    function Circle() {\n        _classCallCheck(this, Circle);\n\n        return _possibleConstructorReturn(this, (Circle.__proto__ || Object.getPrototypeOf(Circle)).apply(this, arguments));\n    }\n\n    _createClass(Circle, [{\n        key: '_renderSelf',\n        value: function _renderSelf(context) {\n            if (!context) {\n                context = this.context;\n            }\n            context.beginPath();\n            if (this.style.stroke) {\n                context.arc(this.style.center.x * this.canvasScale, this.style.center.y * this.canvasScale, this.style.radius * this.canvasScale, 0, 360, false);\n                context.lineWidth = this.style['border-width'];\n                context.strokeStyle = this.style['border-color'];\n                context.stroke();\n            }\n            if (this.style.fill) {\n                context.arc(this.style.center.x * this.canvasScale, this.style.center.y * this.canvasScale, this.style.radius * this.canvasScale, 0, 360, false);\n                context.fillStyle = this.style['background-color'];\n                context.fill();\n            }\n        }\n\n        /**\r\n         * 记录鼠标位置相对于当前图形的坐标\r\n         */\n\n    }, {\n        key: '_setOffsetPosition',\n        value: function _setOffsetPosition() {\n            if (this.offsetChangeAble) {\n                this.offsetX = this.mouseX - (this.style.center.x - this.style.radius);\n                this.offsetY = this.mouseY - (this.style.center.y - this.style.radius);\n            }\n        }\n\n        /**\r\n         * 拖拽时，重新设置图形的位置信息\r\n         */\n\n    }, {\n        key: '_setDraggingPos',\n        value: function _setDraggingPos() {\n            this.setStype({\n                center: {\n                    x: this.style.center.x + (this.mouseX - this.offsetX - (this.style.center.x - this.style.radius)),\n                    y: this.style.center.y + (this.mouseY - this.offsetY - (this.style.center.y - this.style.radius))\n                }\n            });\n        }\n    }]);\n\n    return Circle;\n}(_Node3.default);\n\nexports.default = Circle;\n\n//# sourceURL=webpack:///./src/nodes/circle.js?");

/***/ }),

/***/ "./src/nodes/collection.js":
/*!*********************************!*\
  !*** ./src/nodes/collection.js ***!
  \*********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Node2 = __webpack_require__(/*! ../Node */ \"./src/Node.js\");\n\nvar _Node3 = _interopRequireDefault(_Node2);\n\nvar _util = __webpack_require__(/*! ../helpers/util */ \"./src/helpers/util.js\");\n\nvar _util2 = _interopRequireDefault(_util);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Collection = function (_Node) {\n    _inherits(Collection, _Node);\n\n    function Collection() {\n        var myStyle = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};\n        var myAttrs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};\n\n        _classCallCheck(this, Collection);\n\n        var _myStyle = { stroke: false };\n        _util2.default.mixin(_myStyle, myStyle);\n\n        var _this = _possibleConstructorReturn(this, (Collection.__proto__ || Object.getPrototypeOf(Collection)).call(this, _myStyle, myAttrs));\n\n        _this.on('startDrag', function () {\n            _this.children.forEach(function (node) {\n                node.originStyle = _util2.default.clone(node.style);\n                node.originStyle.center.x = node.originStyle.center.x - _this.style.start.x;\n                node.originStyle.center.y = node.originStyle.center.y - _this.style.start.y;\n                node.originStyle.start.x = node.originStyle.start.x - _this.style.start.x;\n                node.originStyle.start.y = node.originStyle.start.y - _this.style.start.y;\n                node.originStyle.end.x = node.originStyle.end.x - _this.style.start.x;\n                node.originStyle.end.y = node.originStyle.end.y - _this.style.start.y;\n            });\n        });\n\n        _this.on('duringDrag', function () {\n            console.log(_this.mouseX);\n            _this.children.forEach(function (node) {\n                node.style.center.x = node.originStyle.center.x + _this.style.start.x;\n                node.style.center.y = node.originStyle.center.y + _this.style.start.y;\n                node.style.start.x = node.originStyle.start.x + _this.style.start.x;\n                node.style.start.y = node.originStyle.start.y + _this.style.start.y;\n                node.style.end.x = node.originStyle.end.x + _this.style.start.x;\n                node.style.end.y = node.originStyle.end.y + _this.style.start.y;\n            });\n        });\n        return _this;\n    }\n\n    _createClass(Collection, [{\n        key: '_renderSelf',\n        value: function _renderSelf(context) {\n            if (!context) {\n                context = this.context;\n            }\n\n            if (this.style.stroke) {\n                context.beginPath();\n                context.lineWidth = this.style['border-width'];\n                context.strokeStyle = this.style['border-color'];\n                context.rect(this.style.start.x * this.canvasScale, this.style.start.y * this.canvasScale, this.style.width * this.canvasScale, this.style.height * this.canvasScale);\n                context.stroke();\n            }\n            if (this.style.fill) {\n                context.beginPath();\n                context.fillStyle = this.style['background-color'];\n                context.rect(this.style.start.x * this.canvasScale, this.style.start.y * this.canvasScale, this.style.width * this.canvasScale, this.style.height * this.canvasScale);\n                context.fill();\n            }\n\n            this._initChildrenPos();\n\n            context.closePath();\n        }\n    }, {\n        key: '_initChildrenPos',\n        value: function _initChildrenPos() {\n            var _this2 = this;\n\n            if (!this.childrenPosInited) {\n                this.childrenPosInited = true;\n                this.children.forEach(function (node) {\n                    node.style.center.x = _this2.style.center.x + _this2.style.start.x;\n                    node.style.center.y = node.style.center.y + _this2.style.start.y;\n                    node.style.start.x = node.style.start.x + _this2.style.start.x;\n                    node.style.start.y = node.style.start.y + _this2.style.start.y;\n                    node.style.end.x = node.style.end.x + _this2.style.start.x;\n                    node.style.end.y = node.style.end.y + _this2.style.start.y;\n                });\n            }\n        }\n    }, {\n        key: '_checkPointInPath',\n        value: function _checkPointInPath() {\n            var xSpace = this.mouseX - this.style.start.x;\n            var ySpace = this.mouseY - this.style.start.y;\n            return xSpace >= 0 && xSpace <= this.style.width && ySpace >= 0 && ySpace < this.style.height;\n        }\n    }]);\n\n    return Collection;\n}(_Node3.default);\n\nexports.default = Collection;\n\n//# sourceURL=webpack:///./src/nodes/collection.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Node2 = __webpack_require__(/*! ../Node */ \"./src/Node.js\");\n\nvar _Node3 = _interopRequireDefault(_Node2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Font = function (_Node) {\n    _inherits(Font, _Node);\n\n    function Font() {\n        _classCallCheck(this, Font);\n\n        return _possibleConstructorReturn(this, (Font.__proto__ || Object.getPrototypeOf(Font)).apply(this, arguments));\n    }\n\n    _createClass(Font, [{\n        key: '_renderSelf',\n        value: function _renderSelf(context) {\n            var _this2 = this;\n\n            if (!context) {\n                context = this.context;\n            }\n            if (!this.font) {\n                this.font = {\n                    textWidthConfig: {}\n                };\n            }\n            context.beginPath();\n\n            this._autoSplitText();\n            this.font.splitedText.forEach(function (str, index) {\n                context.font = 'normal \\n                ' + _this2.style['font-size'] * _this2.canvasScale + 'px\\n                ' + _this2.style['font-family'];\n                context.fillStyle = _this2.style.color;\n                context.textBaseline = 'hanging';\n                context.textAlign = _this2.style['text-align'];\n                context.fillText(str, _this2.style.start.x * _this2.canvasScale, _this2.style.start.y * _this2.canvasScale + _this2.style['font-size'] * _this2.canvasScale * index + _this2.style['row-spacing'] * _this2.canvasScale * index);\n            });\n            context.closePath();\n        }\n    }, {\n        key: '_getTextWidthConfig',\n        value: function _getTextWidthConfig(context) {\n            var _this3 = this;\n\n            if (!context) {\n                context = this.context;\n            }\n\n            var font = 'normal ' + this.style['font-size'] * this.canvasScale + 'px ' + this.style['font-family'];\n            if (!this.font.textWidthConfig[font]) {\n                context.font = font;\n                var str = ' abcdefghijklmnopqretuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890~!@#$%^&*()_+`-=,./;[]<>?:{}|\\\\\\'\"';\n                var res = {};\n                str.split('').forEach(function (char) {\n                    res[char] = context.measureText(char).width / _this3.canvasScale;\n                });\n                res.hans = context.measureText('我').width / this.canvasScale;\n                this.font.textWidthConfig[this.style['font-family']] = res;\n            }\n            return this.font.textWidthConfig[this.style['font-family']];\n        }\n    }, {\n        key: '_measureTextWidth',\n        value: function _measureTextWidth(context) {\n            if (!context) {\n                context = this.context;\n            }\n\n            var font = 'normal ' + this.style['font-size'] * this.canvasScale + 'px ' + this.style['font-family'];\n            context.font = font;\n            var maxLen = 0;\n            this.font.splitedText.forEach(function (str) {\n                maxLen = Math.max(context.measureText(str).width / 2, maxLen);\n            });\n            this.style.width = maxLen;\n        }\n    }, {\n        key: '_measureTextHeight',\n        value: function _measureTextHeight() {\n            var size = this.font.splitedText.length;\n            this.style.height = this.style['font-size'] * size + this.style['row-spacing'] * (size - 1);\n        }\n    }, {\n        key: '_autoSplitText',\n        value: function _autoSplitText() {\n            var res = [];\n            var str = this.style['font-text'];\n            if (this.style['max-width'] === 'auto') {\n                res = str.split('\\n');\n            } else {\n                var maxWidth = this.style['max-width'];\n                var config = this._getTextWidthConfig();\n                var _str = '';\n                var _strLen = 0;\n                str.split('').forEach(function (char) {\n                    var charLen = config[char];\n                    if (!charLen) {\n                        charLen = config.hans;\n                    }\n                    if (char === '\\n') {\n                        res.push(_str);\n                        _strLen = 0;\n                        _str = '';\n                    } else {\n                        if (_strLen + charLen <= maxWidth) {\n                            _strLen += charLen;\n                            _str += char;\n                        } else {\n                            res.push(_str);\n                            _strLen = charLen;\n                            _str = char;\n                        }\n                    }\n                });\n            }\n            this.font.splitedText = res;\n            this._measureTextWidth();\n            this._measureTextHeight();\n            return res;\n        }\n    }, {\n        key: '_checkPointInPath',\n        value: function _checkPointInPath() {\n            var xSpace = this.mouseX - this.style.start.x;\n            var ySpace = this.mouseY - this.style.start.y;\n            return xSpace >= 0 && xSpace <= this.style.width && ySpace >= 0 && ySpace < this.style.height;\n        }\n    }]);\n\n    return Font;\n}(_Node3.default);\n\nexports.default = Font;\n\n//# sourceURL=webpack:///./src/nodes/font.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Node2 = __webpack_require__(/*! ../Node */ \"./src/Node.js\");\n\nvar _Node3 = _interopRequireDefault(_Node2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Image = function (_Node) {\n    _inherits(Image, _Node);\n\n    function Image() {\n        _classCallCheck(this, Image);\n\n        return _possibleConstructorReturn(this, (Image.__proto__ || Object.getPrototypeOf(Image)).apply(this, arguments));\n    }\n\n    _createClass(Image, [{\n        key: '_renderSelf',\n        value: function _renderSelf(context) {\n            var _this2 = this;\n\n            if (!context) {\n                context = this.context;\n            }\n            if (this.img) {\n                context.drawImage(this.img, this.style.start.x * this.canvasScale, this.style.start.y * this.canvasScale, this.style.width * this.canvasScale, this.style.height * this.canvasScale);\n            } else {\n                var img = document.createElement('img');\n                img.src = this.style['image-src'];\n                img.style.display = 'none';\n                img.onload = function () {\n                    _this2.img = img;\n                    if (_this2.style.width === 0 || _this2.style.width === 'auto') {\n                        _this2.style.width = img.width;\n                    }\n                    if (_this2.style.height === 0 || _this2.style.height === 'auto') {\n                        _this2.style.height = img.height;\n                    }\n                    context.drawImage(_this2.img, _this2.style.start.x * _this2.canvasScale, _this2.style.start.y * _this2.canvasScale, _this2.style.width * _this2.canvasScale, _this2.style.height * _this2.canvasScale);\n                };\n                document.body.appendChild(img);\n            }\n        }\n    }, {\n        key: '_checkPointInPath',\n        value: function _checkPointInPath() {\n            var xSpace = this.mouseX - this.style.start.x;\n            var ySpace = this.mouseY - this.style.start.y;\n            return xSpace >= 0 && xSpace <= this.style.width && ySpace >= 0 && ySpace < this.style.height;\n        }\n    }]);\n\n    return Image;\n}(_Node3.default);\n\nexports.default = Image;\n\n//# sourceURL=webpack:///./src/nodes/image.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _Node2 = __webpack_require__(/*! ../Node */ \"./src/Node.js\");\n\nvar _Node3 = _interopRequireDefault(_Node2);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return call && (typeof call === \"object\" || typeof call === \"function\") ? call : self; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function, not \" + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }\n\nvar Line = function (_Node) {\n    _inherits(Line, _Node);\n\n    function Line() {\n        _classCallCheck(this, Line);\n\n        return _possibleConstructorReturn(this, (Line.__proto__ || Object.getPrototypeOf(Line)).apply(this, arguments));\n    }\n\n    _createClass(Line, [{\n        key: '_renderSelf',\n        value: function _renderSelf(context) {\n            if (!context) {\n                context = this.context;\n            }\n            context.beginPath();\n            context.moveTo(this.style.start.x * this.canvasScale, this.style.start.y * this.canvasScale);\n            context.lineTo(this.style.end.x * this.canvasScale, this.style.end.y * this.canvasScale);\n            context.lineWidth = this.style['border-width'];\n            context.strokeStyle = this.style['border-color'];\n            context.stroke();\n            context.closePath();\n        }\n    }, {\n        key: '_checkPointInPath',\n        value: function _checkPointInPath() {\n            var rate1 = (this.style.end.y - this.style.start.y) / (this.style.end.x - this.style.start.x);\n            var mx = void 0;\n\n            if (rate1 === 0) {\n                mx = this.style.end.y;\n            } else {\n                mx = (this.mouseY - this.style.start.y) / rate1 + this.style.start.x;\n            }\n\n            if (this.mouseX <= Math.max(this.style.start.x, this.style.end.x) && this.mouseX >= Math.min(this.style.start.x, this.style.end.x)) {\n                if (rate1 === 0) {\n                    return Math.abs(this.mouseY - this.style.end.y) < 1;\n                } else {\n                    return Math.abs(mx - this.mouseX) < 1;\n                }\n            } else {\n                return false;\n            }\n        }\n\n        /**\r\n         * 记录鼠标位置相对于当前图形的坐标\r\n         */\n\n    }, {\n        key: '_setOffsetPosition',\n        value: function _setOffsetPosition() {\n            if (this.offsetChangeAble) {\n                this.offsetX = this.mouseX - this.style.start.x;\n                this.offsetY = this.mouseY - this.style.start.y;\n            }\n        }\n\n        /**\r\n         * 拖拽时，重新设置图形的位置信息\r\n         */\n\n    }, {\n        key: '_setDraggingPos',\n        value: function _setDraggingPos() {\n            this.setStype({\n                start: {\n                    x: this.mouseX - this.offsetX,\n                    y: this.mouseY - this.offsetY\n                },\n                end: {\n                    x: this.mouseX - this.offsetX + (this.style.end.x - this.style.start.x),\n                    y: this.mouseY - this.offsetY + (this.style.end.y - this.style.start.y)\n                }\n            });\n        }\n    }]);\n\n    return Line;\n}(_Node3.default);\n\nexports.default = Line;\n\n//# sourceURL=webpack:///./src/nodes/line.js?");
